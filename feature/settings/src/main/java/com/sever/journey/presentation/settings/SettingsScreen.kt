    ...
    Scaffold(
        ...
        Column(
            ...
            ButtonOnSettingsScreen(
                ...
                onClick = {
                    AnalyticsService.logButtonClick("but_delete_all_routes_was_clicked")
                    showDialog = true
                }
            )
            ...
            ButtonOnSettingsScreen(
                ...
                onClick = {
                    AnalyticsService.logButtonClick("but_notif_was_clicked")
                    AnalyticsService.logNotificationSettingsOpened()
        ...
        if (showDialog) {
            DeleteRouteDialog(
                ...
                onConfirm = {
                    AnalyticsService.logRouteDeletedAll()
