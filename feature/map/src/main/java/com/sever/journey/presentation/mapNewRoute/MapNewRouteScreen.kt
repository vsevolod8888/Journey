package com.sever.journey.presentation.mapNewRoute
...
fun MapNewRouteScreen(
    ...
    LaunchedEffect(Unit) {
        AnalyticsService.logScreenView("MapNewRouteScreen")
    }
        ...
        Box(
            ...
            Column(
                ...
                Button(
                    ...
                    modifier = Modifier.padding(16.dp),
                    onClick = {
                        AnalyticsService.logRouteSaved(routeId.toString(), "new_route")
                        scope.launch {
                            onStopService()
                            navController.popBackStack()
                        }
    ...
    BackHandler {
        AnalyticsService.logRouteDiscarded(routeId.toString())
        scope.launch {
