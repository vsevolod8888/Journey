package com.sever.journey.presentation.mapDraw
...
@Composable
fun MapDrawScreen(viewModel: MapViewModel, navController: NavHostController, routeName: String?) {
    ...
    LaunchedEffect(Unit) {
        AnalyticsService.logScreenView("MapDrawScreen")
    }
        ...
        Box(
            ...
            Column(
                ...
                Button(
                    ...
                    onClick = {
                        AnalyticsService.logRouteSaved(routeName ?: "", "draw")
                        scope.launch {
    ...
    BackHandler {
        AnalyticsService.logRouteDiscarded(routeName ?: "")
        scope.launch {
