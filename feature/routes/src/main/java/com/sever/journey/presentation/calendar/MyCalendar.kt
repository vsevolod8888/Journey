package com.sever.journey.presentation.calendar
...
import com.sever.journey.presentation.calendar.CalendarConstants.INITIAL_PAGE_INDEX
import com.sever.journey.presentation.calendar.CalendarConstants.MAX_PAGES
    ...
    HorizontalCalendarView(
        ...
        calendarView = { monthOffset ->
            CalendarView(
                ...
                dayOfWeekLabel = {
                    MyWeekDayForBigCalendar(it.name.first().toString().uppercase(Locale.ROOT))
                },
                )
        })
}
